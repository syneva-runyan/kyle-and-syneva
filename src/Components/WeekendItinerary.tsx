        ...
        <>
           ...
           <ul>
            ...
            <ul>
                ...
                <li><strong>7pm - 8pm</strong>  Rehearsal Dinner (Dress code - <a href="https://www.theknot.com/content/what-to-wear-casual" target="_blank" rel="noopener noreferrer" >smart casual</a>)</li>
            ...
            <ul>
                ...
                <li><strong>4pm - 4:30pm</strong> Wedding Ceremony (Dress code - semi-formal)</li>
                <li><strong>4:30 - 6pm</strong> Cocktail Party</li>
                <li><strong>6pm - late</strong> Dinner + Reception</li>
            </ul>
            <h3 >Sunday, June 8th</h3>
            <ul>
                <li><strong>8:30am</strong> Breakfast</li>
                <li><strong>11am</strong> Checkout</li>
            </ul>
        </>
    );
}

export default WeekendItinerary;
