...
const qAnda= [{
    ...
    {
    question: "How can I get to Hawkesdene?",
    ...
    answer: "We don't expect everyone to make the whole weekend and will be happy to see you at all! Just make sure to include your plans in the RSVP.",
}, {
